...
//		Debug.Log ("ID = " + ID);
	...
	void OnCollisionEnter(){
		...
		// this.knowledgeBase.Bidknowledge.Cleanup();
		// this.knowledgeBase.Bidknowledge.Cleanup();
		// foreach (SearchTile s in this.knowledgeBase.Bidknowledge.claimedTiles) {
		// 	s.CleanUp();
		// }
		// this.knowledgeBase.Bidknowledge.claimedTiles.Clear ();
		// this.knowledgeBase.Bidknowledge.claimedTiles = null;
