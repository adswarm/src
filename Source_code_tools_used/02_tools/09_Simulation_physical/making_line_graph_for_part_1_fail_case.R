...
plot(t_cf1$x.m., t_cf1$y.m., type = "n", xlim = c(-0.3, 3.3), ylim = c(1.9, 3.7), main = "Part 1 (naive)")
...
###
csvname = paste(input_directory,"integrated_wp_part_04_trial_03_14_fail_2.csv",sep="" )
