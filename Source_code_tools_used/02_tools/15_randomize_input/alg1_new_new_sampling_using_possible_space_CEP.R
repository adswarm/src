...
outputplotdir2 <- paste("~/Research/tool_project_swarm_safety/Preprocessing_R/data/02_01_output_plot/",filename,target_param,coef_param,"l",".png",sep="" )
...
for (mode in c('f1','f2','f3')){
  ...
  outputplotdir2 <- paste("~/Research/tool_project_swarm_safety/Preprocessing_R/data/02_01_output_plot/",filename,target_param,coef_param,mode,".png",sep="" )
  ggsave(outputplotdir2) # refer: https://ggplot2.tidyverse.org/reference/ggsave.html 
